<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryUI.aspx.cs" Inherits="HelloWorldFromWebApp.StocksManagement.UI.CategoryUI" %>
    ...
    <form id="form1" runat="server">
        <div>
            <fieldset>
                ...
                <asp:GridView runat="server" ID="categoryGridView" AutoGenerateColumns="False">
                    <Columns>
